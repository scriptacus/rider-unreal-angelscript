...
if [ "$darwin" = "true" ]; then
    ...
    x86_64)
        ...
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.5_macos-x64_bin
        ;;
    arm64)
        JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.5_macos-aarch64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.5_macos-aarch64_bin
        ;;
    *)
    ...
    JVM_ARCH=$(linux$(getconf LONG_BIT) uname -m)
     case $JVM_ARCH in
        x86_64)
            ...
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.5_linux-x64_bin
            ;;
        aarch64)
            JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.5_linux-aarch64_bin.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.5_linux-aarch64_bin
            ;;
        *)
            die "Unknown architecture $JVM_ARCH"
            ;;
