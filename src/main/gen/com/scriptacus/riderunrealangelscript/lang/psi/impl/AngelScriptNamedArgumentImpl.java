...
public class AngelScriptNamedArgumentImpl extends ASTWrapperPsiElement implements AngelScriptNamedArgument {

  public AngelScriptNamedArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
