...
public class AngelScriptVariableInitializerImpl extends ASTWrapperPsiElement implements AngelScriptVariableInitializer {

  public AngelScriptVariableInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
