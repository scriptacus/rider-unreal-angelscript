...
public class AngelScriptFunctionCallImpl extends ASTWrapperPsiElement implements AngelScriptFunctionCall {

  public AngelScriptFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
