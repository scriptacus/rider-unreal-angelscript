...
public class AngelScriptAdditiveExprImpl extends AngelScriptExprImpl implements AngelScriptAdditiveExpr {

  public AngelScriptAdditiveExprImpl(@NotNull ASTNode node) {
    super(node);
  }
