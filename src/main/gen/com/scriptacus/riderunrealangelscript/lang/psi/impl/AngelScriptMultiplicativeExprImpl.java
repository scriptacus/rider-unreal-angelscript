...
public class AngelScriptMultiplicativeExprImpl extends AngelScriptExprImpl implements AngelScriptMultiplicativeExpr {

  public AngelScriptMultiplicativeExprImpl(@NotNull ASTNode node) {
    super(node);
  }
