...
public class AngelScriptIdentifierReferenceImpl extends ASTWrapperPsiElement implements AngelScriptIdentifierReference {

  public AngelScriptIdentifierReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
