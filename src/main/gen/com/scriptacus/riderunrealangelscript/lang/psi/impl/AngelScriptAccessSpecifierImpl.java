...
public class AngelScriptAccessSpecifierImpl extends ASTWrapperPsiElement implements AngelScriptAccessSpecifier {

  public AngelScriptAccessSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }
