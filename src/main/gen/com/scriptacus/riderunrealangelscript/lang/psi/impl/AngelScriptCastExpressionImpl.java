...
public class AngelScriptCastExpressionImpl extends ASTWrapperPsiElement implements AngelScriptCastExpression {

  public AngelScriptCastExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
