...
public class AngelScriptFunctionBodyImpl extends ASTWrapperPsiElement implements AngelScriptFunctionBody {

  public AngelScriptFunctionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
