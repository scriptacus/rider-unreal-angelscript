...
public class AngelScriptArgumentListImpl extends ASTWrapperPsiElement implements AngelScriptArgumentList {

  public AngelScriptArgumentListImpl(@NotNull ASTNode node) {
    super(node);
  }
