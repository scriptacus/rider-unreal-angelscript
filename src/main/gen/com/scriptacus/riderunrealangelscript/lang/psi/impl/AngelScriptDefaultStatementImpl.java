...
public class AngelScriptDefaultStatementImpl extends ASTWrapperPsiElement implements AngelScriptDefaultStatement {

  public AngelScriptDefaultStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
