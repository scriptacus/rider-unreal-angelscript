...
public class AngelScriptStringLiteralImpl extends ASTWrapperPsiElement implements AngelScriptStringLiteral {

  public AngelScriptStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
