...
public class AngelScriptAccessModifierImpl extends ASTWrapperPsiElement implements AngelScriptAccessModifier {

  public AngelScriptAccessModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
