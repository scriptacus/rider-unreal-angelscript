...
public class AngelScriptPrimitiveTypeImpl extends ASTWrapperPsiElement implements AngelScriptPrimitiveType {

  public AngelScriptPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
