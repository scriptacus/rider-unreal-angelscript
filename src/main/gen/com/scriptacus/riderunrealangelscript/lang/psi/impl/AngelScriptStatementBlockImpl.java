...
public class AngelScriptStatementBlockImpl extends ASTWrapperPsiElement implements AngelScriptStatementBlock {

  public AngelScriptStatementBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
