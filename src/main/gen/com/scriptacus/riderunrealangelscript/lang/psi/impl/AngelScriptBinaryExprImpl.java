...
public class AngelScriptBinaryExprImpl extends AngelScriptExprImpl implements AngelScriptBinaryExpr {

  public AngelScriptBinaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AngelScriptExpr getLeft() {
    List<AngelScriptExpr> p1 = getExprList();
    return p1.get(0);
  }

  @Override
  @Nullable
  public AngelScriptExpr getRight() {
    List<AngelScriptExpr> p1 = getExprList();
