...
public class AngelScriptBitwiseXorExprImpl extends AngelScriptExprImpl implements AngelScriptBitwiseXorExpr {

  public AngelScriptBitwiseXorExprImpl(@NotNull ASTNode node) {
    super(node);
  }
