...
public class AngelScriptAccessLevelImpl extends ASTWrapperPsiElement implements AngelScriptAccessLevel {

  public AngelScriptAccessLevelImpl(@NotNull ASTNode node) {
    super(node);
  }
