...
public class AngelScriptDefaultParameterValueImpl extends ASTWrapperPsiElement implements AngelScriptDefaultParameterValue {

  public AngelScriptDefaultParameterValueImpl(@NotNull ASTNode node) {
    super(node);
  }
