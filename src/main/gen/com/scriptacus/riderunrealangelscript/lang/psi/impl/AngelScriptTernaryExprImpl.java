...
public class AngelScriptTernaryExprImpl extends AngelScriptExprImpl implements AngelScriptTernaryExpr {

  public AngelScriptTernaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
