...
public class AngelScriptUmetaMacroImpl extends ASTWrapperPsiElement implements AngelScriptUmetaMacro {

  public AngelScriptUmetaMacroImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitUmetaMacro(this);
  }
