...
public class AngelScriptClassInheritanceImpl extends ASTWrapperPsiElement implements AngelScriptClassInheritance {

  public AngelScriptClassInheritanceImpl(@NotNull ASTNode node) {
    super(node);
  }
