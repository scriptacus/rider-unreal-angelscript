...
public class AngelScriptForUpdateImpl extends ASTWrapperPsiElement implements AngelScriptForUpdate {

  public AngelScriptForUpdateImpl(@NotNull ASTNode node) {
    super(node);
  }
