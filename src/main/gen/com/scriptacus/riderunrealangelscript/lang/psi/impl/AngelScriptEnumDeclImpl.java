...
public class AngelScriptEnumDeclImpl extends ASTWrapperPsiElement implements AngelScriptEnumDecl {
  ...
  @Override
  @Nullable
  public AngelScriptEnumBody getEnumBody() {
    return findChildByClass(AngelScriptEnumBody.class);
  }

  @Override
  @Nullable
  public AngelScriptUenumMacro getUenumMacro() {
    return findChildByClass(AngelScriptUenumMacro.class);
  }
