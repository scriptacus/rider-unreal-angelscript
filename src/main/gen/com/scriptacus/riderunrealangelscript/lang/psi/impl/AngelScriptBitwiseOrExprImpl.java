...
public class AngelScriptBitwiseOrExprImpl extends AngelScriptExprImpl implements AngelScriptBitwiseOrExpr {

  public AngelScriptBitwiseOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
