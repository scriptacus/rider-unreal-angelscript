...
public class AngelScriptReturnTypeImpl extends ASTWrapperPsiElement implements AngelScriptReturnType {

  public AngelScriptReturnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
