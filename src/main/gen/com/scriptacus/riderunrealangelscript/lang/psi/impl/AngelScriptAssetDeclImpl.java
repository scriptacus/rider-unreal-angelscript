...
public class AngelScriptAssetDeclImpl extends ASTWrapperPsiElement implements AngelScriptAssetDecl {

  public AngelScriptAssetDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitAssetDecl(this);
  }
  ...
  @Override
  @Nullable
  public AngelScriptAssetBody getAssetBody() {
    return findChildByClass(AngelScriptAssetBody.class);
  }
